...
def clean():
    ...
    (data_root / "node_test_with_central_model" / "x_train.csv").rm(absent="ignore")
    (data_root / "node_test_with_central_model" / "y_train.csv").rm(absent="ignore")
    (data_root / "node_test_with_central_model" / "x_test.csv").rm(absent="ignore")
    (data_root / "node_test_with_central_model" / "y_test.csv").rm(absent="ignore")
    ...
    (data_root / "node_test_with_central_model" / "plots_train").rmdir(absent="ignore")
    (data_root / "node_test_with_central_model" / "plots_test").rmdir(absent="ignore")
